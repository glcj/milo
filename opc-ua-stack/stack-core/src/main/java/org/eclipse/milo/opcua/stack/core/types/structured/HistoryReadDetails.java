...
public class HistoryReadDetails implements UaStructure {
    ...
    public static class BinaryCodec implements OpcBinaryTypeCodec<HistoryReadDetails> {
        @Override
    ...
    public static class XmlCodec implements OpcXmlTypeCodec<HistoryReadDetails> {
        @Override
