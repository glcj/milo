...
public class RegisterServerResponse implements UaResponseMessage {
    ...
    public static class BinaryCodec implements OpcBinaryTypeCodec<RegisterServerResponse> {
        @Override
    ...
    public static class XmlCodec implements OpcXmlTypeCodec<RegisterServerResponse> {
        @Override
