...
public enum EnumeratedTestType implements UaEnumeration {
    ...
    static {
        OpcUaTypeDictionary.registerEncoder(EnumeratedTestType::encode, EnumeratedTestType.class);
        OpcUaTypeDictionary.registerDecoder(EnumeratedTestType::decode, EnumeratedTestType.class);
    }
