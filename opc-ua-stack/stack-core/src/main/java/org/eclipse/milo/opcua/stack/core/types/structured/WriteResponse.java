...
public class WriteResponse implements UaResponseMessage {
    ...
    static {
        OpcUaTypeDictionary.registerEncoder(WriteResponse::encode, WriteResponse.class, BinaryEncodingId, XmlEncodingId);
        OpcUaTypeDictionary.registerDecoder(WriteResponse::decode, WriteResponse.class, BinaryEncodingId, XmlEncodingId);
    }
