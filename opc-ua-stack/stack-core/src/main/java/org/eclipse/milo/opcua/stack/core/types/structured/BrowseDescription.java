...
public class BrowseDescription implements UaStructure {
    ...
    public static class BinaryCodec implements OpcBinaryTypeCodec<BrowseDescription> {
        @Override
    ...
    public static class XmlCodec implements OpcXmlTypeCodec<BrowseDescription> {
        @Override
