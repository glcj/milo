...
public class ModifyMonitoredItemsResponse implements UaResponseMessage {
    ...
    public static class BinaryCodec implements OpcBinaryTypeCodec<ModifyMonitoredItemsResponse> {
        @Override
            ...
            MonitoredItemModifyResult[] _results =
                reader.readArray(
                    () -> (MonitoredItemModifyResult) context.decode(
                        OpcUaTypeDictionary.NAMESPACE_URI, "MonitoredItemModifyResult", reader),
        ...
        public void encode(SerializationContext context, ModifyMonitoredItemsResponse encodable, OpcBinaryStreamWriter writer) throws UaSerializationException {
            ...
            writer.writeArray(
                encodable._results,
                e -> context.encode(OpcUaTypeDictionary.NAMESPACE_URI, "MonitoredItemModifyResult", e, writer)
            );
            writer.writeArray(encodable._diagnosticInfos, writer::writeDiagnosticInfo);
        }
    }

    public static class XmlCodec implements OpcXmlTypeCodec<ModifyMonitoredItemsResponse> {
        @Override
        ...
        public void encode(SerializationContext context, ModifyMonitoredItemsResponse encodable, OpcXmlStreamWriter writer) throws UaSerializationException {
            ...
            writer.writeArray(
                "Results",
                encodable._results,
                (f, e) -> context.encode(OpcUaTypeDictionary.NAMESPACE_URI, "MonitoredItemModifyResult", e, writer)
            );
