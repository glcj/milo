...
public class SamplingIntervalDiagnosticsDataType implements UaStructure {
    ...
    public static class BinaryCodec implements OpcBinaryTypeCodec<SamplingIntervalDiagnosticsDataType> {
        @Override
    ...
    public static class XmlCodec implements OpcXmlTypeCodec<SamplingIntervalDiagnosticsDataType> {
        @Override
