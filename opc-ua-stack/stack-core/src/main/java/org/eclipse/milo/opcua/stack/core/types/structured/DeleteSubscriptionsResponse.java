...
public class DeleteSubscriptionsResponse implements UaResponseMessage {
    ...
    public static class BinaryCodec implements OpcBinaryTypeCodec<DeleteSubscriptionsResponse> {
        @Override
    ...
    public static class XmlCodec implements OpcXmlTypeCodec<DeleteSubscriptionsResponse> {
        @Override
