...
public class CloseSessionResponse implements UaResponseMessage {
    ...
    public static class BinaryCodec implements OpcBinaryTypeCodec<CloseSessionResponse> {
        @Override
    ...
    public static class XmlCodec implements OpcXmlTypeCodec<CloseSessionResponse> {
        @Override
