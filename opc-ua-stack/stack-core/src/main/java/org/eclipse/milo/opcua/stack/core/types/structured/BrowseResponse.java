...
public class BrowseResponse implements UaResponseMessage {
    ...
    static {
        OpcUaTypeDictionary.registerEncoder(BrowseResponse::encode, BrowseResponse.class, BinaryEncodingId, XmlEncodingId);
        OpcUaTypeDictionary.registerDecoder(BrowseResponse::decode, BrowseResponse.class, BinaryEncodingId, XmlEncodingId);
    }
