...
public class HistoryReadValueId implements UaStructure {
    ...
    public static class BinaryCodec implements OpcBinaryTypeCodec<HistoryReadValueId> {
        @Override
    ...
    public static class XmlCodec implements OpcXmlTypeCodec<HistoryReadValueId> {
        @Override
