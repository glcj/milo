...
public class NotificationData implements UaStructure {
    ...
    static {
        OpcUaTypeDictionary.registerEncoder(NotificationData::encode, NotificationData.class, BinaryEncodingId, XmlEncodingId);
        OpcUaTypeDictionary.registerDecoder(NotificationData::decode, NotificationData.class, BinaryEncodingId, XmlEncodingId);
    }
