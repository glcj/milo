...
public class CreateMonitoredItemsResponse implements UaResponseMessage {
    ...
    public static class BinaryCodec implements OpcBinaryTypeCodec<CreateMonitoredItemsResponse> {
        @Override
            ...
            MonitoredItemCreateResult[] _results =
                reader.readArray(
                    () -> (MonitoredItemCreateResult) context.decode(
                        OpcUaTypeDictionary.NAMESPACE_URI, "MonitoredItemCreateResult", reader),
        ...
        public void encode(SerializationContext context, CreateMonitoredItemsResponse encodable, OpcBinaryStreamWriter writer) throws UaSerializationException {
            ...
            writer.writeArray(
                encodable._results,
                e -> context.encode(OpcUaTypeDictionary.NAMESPACE_URI, "MonitoredItemCreateResult", e, writer)
            );
            writer.writeArray(encodable._diagnosticInfos, writer::writeDiagnosticInfo);
        }
    }

    public static class XmlCodec implements OpcXmlTypeCodec<CreateMonitoredItemsResponse> {
        @Override
        ...
        public void encode(SerializationContext context, CreateMonitoredItemsResponse encodable, OpcXmlStreamWriter writer) throws UaSerializationException {
            ...
            writer.writeArray(
                "Results",
                encodable._results,
                (f, e) -> context.encode(OpcUaTypeDictionary.NAMESPACE_URI, "MonitoredItemCreateResult", e, writer)
            );
