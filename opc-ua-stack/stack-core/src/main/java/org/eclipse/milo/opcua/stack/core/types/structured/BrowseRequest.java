...
public class BrowseRequest implements UaRequestMessage {
    ...
    public static class BinaryCodec implements OpcBinaryTypeCodec<BrowseRequest> {
        @Override
            ...
            BrowseDescription[] _nodesToBrowse =
                reader.readArray(
                    () -> (BrowseDescription) context.decode(
                        OpcUaTypeDictionary.NAMESPACE_URI, "BrowseDescription", reader),
        ...
        public void encode(SerializationContext context, BrowseRequest encodable, OpcBinaryStreamWriter writer) throws UaSerializationException {
            ...
            writer.writeArray(
                ...
                e -> context.encode(OpcUaTypeDictionary.NAMESPACE_URI, "BrowseDescription", e, writer)
            );
        }
    }

    public static class XmlCodec implements OpcXmlTypeCodec<BrowseRequest> {
        @Override
        ...
        public void encode(SerializationContext context, BrowseRequest encodable, OpcXmlStreamWriter writer) throws UaSerializationException {
            ...
            writer.writeArray(
                "NodesToBrowse",
                encodable._nodesToBrowse,
                (f, e) -> context.encode(OpcUaTypeDictionary.NAMESPACE_URI, "BrowseDescription", e, writer)
            );
        }
    }
