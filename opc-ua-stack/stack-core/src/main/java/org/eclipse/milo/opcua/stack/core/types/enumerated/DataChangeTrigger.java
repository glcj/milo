...
public enum DataChangeTrigger implements UaEnumeration {
    ...
    static {
        OpcUaTypeDictionary.registerEncoder(DataChangeTrigger::encode, DataChangeTrigger.class);
        OpcUaTypeDictionary.registerDecoder(DataChangeTrigger::decode, DataChangeTrigger.class);
    }
