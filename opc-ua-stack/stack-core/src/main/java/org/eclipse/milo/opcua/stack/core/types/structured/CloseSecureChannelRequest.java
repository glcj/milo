...
public class CloseSecureChannelRequest implements UaRequestMessage {
    ...
    public static class BinaryCodec implements OpcBinaryTypeCodec<CloseSecureChannelRequest> {
        @Override
        ...
        @Override
        public void encode(SerializationContext context, CloseSecureChannelRequest encodable, OpcBinaryStreamWriter writer) throws UaSerializationException {
            context.encode(OpcUaTypeDictionary.NAMESPACE_URI, "RequestHeader", encodable._requestHeader, writer);
        }
    }

    public static class XmlCodec implements OpcXmlTypeCodec<CloseSecureChannelRequest> {
        @Override
