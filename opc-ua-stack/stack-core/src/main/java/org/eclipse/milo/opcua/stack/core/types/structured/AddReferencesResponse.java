...
public class AddReferencesResponse implements UaResponseMessage {
    ...
    public static class BinaryCodec implements OpcBinaryTypeCodec<AddReferencesResponse> {
        @Override
    ...
    public static class XmlCodec implements OpcXmlTypeCodec<AddReferencesResponse> {
        @Override
