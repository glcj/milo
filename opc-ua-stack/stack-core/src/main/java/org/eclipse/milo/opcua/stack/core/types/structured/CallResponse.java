...
public class CallResponse implements UaResponseMessage {
    ...
    static {
        OpcUaTypeDictionary.registerEncoder(CallResponse::encode, CallResponse.class, BinaryEncodingId, XmlEncodingId);
        OpcUaTypeDictionary.registerDecoder(CallResponse::decode, CallResponse.class, BinaryEncodingId, XmlEncodingId);
    }
