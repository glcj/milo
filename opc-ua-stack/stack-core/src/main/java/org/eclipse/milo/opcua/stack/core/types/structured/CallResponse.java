...
public class CallResponse implements UaResponseMessage {
    ...
    public static class BinaryCodec implements OpcBinaryTypeCodec<CallResponse> {
        @Override
            ...
            CallMethodResult[] _results =
                reader.readArray(
                    () -> (CallMethodResult) context.decode(
                        OpcUaTypeDictionary.NAMESPACE_URI, "CallMethodResult", reader),
        ...
        public void encode(SerializationContext context, CallResponse encodable, OpcBinaryStreamWriter writer) throws UaSerializationException {
            ...
            writer.writeArray(
                encodable._results,
                e -> context.encode(OpcUaTypeDictionary.NAMESPACE_URI, "CallMethodResult", e, writer)
            );
            writer.writeArray(encodable._diagnosticInfos, writer::writeDiagnosticInfo);
        }
    }

    public static class XmlCodec implements OpcXmlTypeCodec<CallResponse> {
        @Override
        ...
        public void encode(SerializationContext context, CallResponse encodable, OpcXmlStreamWriter writer) throws UaSerializationException {
            ...
            writer.writeArray(
                "Results",
                encodable._results,
                (f, e) -> context.encode(OpcUaTypeDictionary.NAMESPACE_URI, "CallMethodResult", e, writer)
            );
