...
public class HistoryReadResponse implements UaResponseMessage {
    ...
    public static class BinaryCodec implements OpcBinaryTypeCodec<HistoryReadResponse> {
        @Override
            ...
            HistoryReadResult[] _results =
                reader.readArray(
                    () -> (HistoryReadResult) context.decode(
                        OpcUaTypeDictionary.NAMESPACE_URI, "HistoryReadResult", reader),
        ...
        public void encode(SerializationContext context, HistoryReadResponse encodable, OpcBinaryStreamWriter writer) throws UaSerializationException {
            ...
            writer.writeArray(
                encodable._results,
                e -> context.encode(OpcUaTypeDictionary.NAMESPACE_URI, "HistoryReadResult", e, writer)
            );
            writer.writeArray(encodable._diagnosticInfos, writer::writeDiagnosticInfo);
        }
    }

    public static class XmlCodec implements OpcXmlTypeCodec<HistoryReadResponse> {
        @Override
        ...
        public void encode(SerializationContext context, HistoryReadResponse encodable, OpcXmlStreamWriter writer) throws UaSerializationException {
            ...
            writer.writeArray(
                "Results",
                encodable._results,
                (f, e) -> context.encode(OpcUaTypeDictionary.NAMESPACE_URI, "HistoryReadResult", e, writer)
            );
