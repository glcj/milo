...
public class HistoryUpdateResponse implements UaResponseMessage {
    ...
    static {
        OpcUaTypeDictionary.registerEncoder(HistoryUpdateResponse::encode, HistoryUpdateResponse.class, BinaryEncodingId, XmlEncodingId);
        OpcUaTypeDictionary.registerDecoder(HistoryUpdateResponse::decode, HistoryUpdateResponse.class, BinaryEncodingId, XmlEncodingId);
    }
