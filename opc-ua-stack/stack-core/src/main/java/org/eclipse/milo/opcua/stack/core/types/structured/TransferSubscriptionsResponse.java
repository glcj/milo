...
public class TransferSubscriptionsResponse implements UaResponseMessage {
    ...
    public static class BinaryCodec implements OpcBinaryTypeCodec<TransferSubscriptionsResponse> {
        @Override
            ...
            TransferResult[] _results =
                reader.readArray(
                    () -> (TransferResult) context.decode(
                        OpcUaTypeDictionary.NAMESPACE_URI, "TransferResult", reader),
        ...
        public void encode(SerializationContext context, TransferSubscriptionsResponse encodable, OpcBinaryStreamWriter writer) throws UaSerializationException {
            ...
            writer.writeArray(
                encodable._results,
                e -> context.encode(OpcUaTypeDictionary.NAMESPACE_URI, "TransferResult", e, writer)
            );
            writer.writeArray(encodable._diagnosticInfos, writer::writeDiagnosticInfo);
        }
    }

    public static class XmlCodec implements OpcXmlTypeCodec<TransferSubscriptionsResponse> {
        @Override
        ...
        public void encode(SerializationContext context, TransferSubscriptionsResponse encodable, OpcXmlStreamWriter writer) throws UaSerializationException {
            ...
            writer.writeArray(
                "Results",
                encodable._results,
                (f, e) -> context.encode(OpcUaTypeDictionary.NAMESPACE_URI, "TransferResult", e, writer)
            );
