...
public class ObjectTypeAttributes extends NodeAttributes {
    ...
    public static class BinaryCodec implements OpcBinaryTypeCodec<ObjectTypeAttributes> {
        @Override
        public ObjectTypeAttributes decode(SerializationContext context, OpcBinaryStreamReader reader) throws UaSerializationException {
        ...
        @Override
        public void encode(SerializationContext context, ObjectTypeAttributes encodable, OpcBinaryStreamWriter writer) throws UaSerializationException {
    ...
    public static class XmlCodec implements OpcXmlTypeCodec<ObjectTypeAttributes> {
        @Override
        public ObjectTypeAttributes decode(SerializationContext context, OpcXmlStreamReader reader) throws UaSerializationException {
        ...
        @Override
        public void encode(SerializationContext context, ObjectTypeAttributes encodable, OpcXmlStreamWriter writer) throws UaSerializationException {
