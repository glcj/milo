...
public class DiscoveryConfiguration implements UaStructure {
    ...
    static {
        OpcUaTypeDictionary.registerEncoder(DiscoveryConfiguration::encode, DiscoveryConfiguration.class, BinaryEncodingId, XmlEncodingId);
        OpcUaTypeDictionary.registerDecoder(DiscoveryConfiguration::decode, DiscoveryConfiguration.class, BinaryEncodingId, XmlEncodingId);
    }
