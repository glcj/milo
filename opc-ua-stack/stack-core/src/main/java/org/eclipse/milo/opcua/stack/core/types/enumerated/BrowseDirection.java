...
public enum BrowseDirection implements UaEnumeration {
    ...
    static {
        OpcUaTypeDictionary.registerEncoder(BrowseDirection::encode, BrowseDirection.class);
        OpcUaTypeDictionary.registerDecoder(BrowseDirection::decode, BrowseDirection.class);
    }
