...
public class UnregisterNodesResponse implements UaResponseMessage {
    ...
    public static class BinaryCodec implements OpcBinaryTypeCodec<UnregisterNodesResponse> {
        @Override
        ...
        @Override
        public void encode(SerializationContext context, UnregisterNodesResponse encodable, OpcBinaryStreamWriter writer) throws UaSerializationException {
            context.encode(OpcUaTypeDictionary.NAMESPACE_URI, "ResponseHeader", encodable._responseHeader, writer);
        }
    }

    public static class XmlCodec implements OpcXmlTypeCodec<UnregisterNodesResponse> {
        @Override
