...
public class AddReferencesRequest implements UaRequestMessage {
    ...
    public static class BinaryCodec implements OpcBinaryTypeCodec<AddReferencesRequest> {
        @Override
            ...
            AddReferencesItem[] _referencesToAdd =
                reader.readArray(
                    () -> (AddReferencesItem) context.decode(
                        OpcUaTypeDictionary.NAMESPACE_URI, "AddReferencesItem", reader),
        ...
        public void encode(SerializationContext context, AddReferencesRequest encodable, OpcBinaryStreamWriter writer) throws UaSerializationException {
            ...
            writer.writeArray(
                ...
                e -> context.encode(OpcUaTypeDictionary.NAMESPACE_URI, "AddReferencesItem", e, writer)
            );
        }
    }

    public static class XmlCodec implements OpcXmlTypeCodec<AddReferencesRequest> {
        @Override
        ...
        public void encode(SerializationContext context, AddReferencesRequest encodable, OpcXmlStreamWriter writer) throws UaSerializationException {
            ...
            writer.writeArray(
                "ReferencesToAdd",
                encodable._referencesToAdd,
                (f, e) -> context.encode(OpcUaTypeDictionary.NAMESPACE_URI, "AddReferencesItem", e, writer)
            );
        }
    }
