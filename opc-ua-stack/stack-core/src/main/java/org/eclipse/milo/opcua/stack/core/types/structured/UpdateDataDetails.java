...
public class UpdateDataDetails extends HistoryUpdateDetails {
    ...
    public static class BinaryCodec implements OpcBinaryTypeCodec<UpdateDataDetails> {
        @Override
    ...
    public static class XmlCodec implements OpcXmlTypeCodec<UpdateDataDetails> {
        @Override
