...
public class RelativePathElement implements UaStructure {
    ...
    public static class BinaryCodec implements OpcBinaryTypeCodec<RelativePathElement> {
        @Override
    ...
    public static class XmlCodec implements OpcXmlTypeCodec<RelativePathElement> {
        @Override
