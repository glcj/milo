...
public class ObjectAttributes extends NodeAttributes {
    ...
    public static class BinaryCodec implements OpcBinaryTypeCodec<ObjectAttributes> {
        @Override
    ...
    public static class XmlCodec implements OpcXmlTypeCodec<ObjectAttributes> {
        @Override
