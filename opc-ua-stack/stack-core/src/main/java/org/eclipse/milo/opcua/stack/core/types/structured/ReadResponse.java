...
public class ReadResponse implements UaResponseMessage {
    ...
    static {
        OpcUaTypeDictionary.registerEncoder(ReadResponse::encode, ReadResponse.class, BinaryEncodingId, XmlEncodingId);
        OpcUaTypeDictionary.registerDecoder(ReadResponse::decode, ReadResponse.class, BinaryEncodingId, XmlEncodingId);
    }
