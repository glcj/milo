...
public class DeleteNodesResponse implements UaResponseMessage {
    ...
    public static class BinaryCodec implements OpcBinaryTypeCodec<DeleteNodesResponse> {
        @Override
    ...
    public static class XmlCodec implements OpcXmlTypeCodec<DeleteNodesResponse> {
        @Override
