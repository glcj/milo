...
public class Node implements UaStructure {
    ...
    public static class BinaryCodec implements OpcBinaryTypeCodec<Node> {
        @Override
        ...
        @Override
        public void encode(SerializationContext context, Node encodable, OpcBinaryStreamWriter writer) throws UaSerializationException {
    ...
    public static class XmlCodec implements OpcXmlTypeCodec<Node> {
        @Override
