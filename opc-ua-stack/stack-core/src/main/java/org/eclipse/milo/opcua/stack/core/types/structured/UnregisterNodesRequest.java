...
public class UnregisterNodesRequest implements UaRequestMessage {
    ...
    public static class BinaryCodec implements OpcBinaryTypeCodec<UnregisterNodesRequest> {
        @Override
    ...
    public static class XmlCodec implements OpcXmlTypeCodec<UnregisterNodesRequest> {
        @Override
