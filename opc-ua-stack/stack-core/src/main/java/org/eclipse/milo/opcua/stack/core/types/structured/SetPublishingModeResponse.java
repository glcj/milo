...
public class SetPublishingModeResponse implements UaResponseMessage {
    ...
    static {
        OpcUaTypeDictionary.registerEncoder(SetPublishingModeResponse::encode, SetPublishingModeResponse.class, BinaryEncodingId, XmlEncodingId);
        OpcUaTypeDictionary.registerDecoder(SetPublishingModeResponse::decode, SetPublishingModeResponse.class, BinaryEncodingId, XmlEncodingId);
    }
