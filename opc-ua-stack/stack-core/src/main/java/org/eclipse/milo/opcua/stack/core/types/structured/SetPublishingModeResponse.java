...
public class SetPublishingModeResponse implements UaResponseMessage {
    ...
    public static class BinaryCodec implements OpcBinaryTypeCodec<SetPublishingModeResponse> {
        @Override
    ...
    public static class XmlCodec implements OpcXmlTypeCodec<SetPublishingModeResponse> {
        @Override
