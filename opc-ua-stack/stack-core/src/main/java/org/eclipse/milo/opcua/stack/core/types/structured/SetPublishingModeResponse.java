...
public class SetPublishingModeResponse implements UaResponseMessage {
    ...
    public static class BinaryCodec implements OpcBinaryDataTypeCodec<SetPublishingModeResponse> {
        @Override
        public SetPublishingModeResponse decode(SerializationContext context, OpcBinaryStreamReader reader) throws UaSerializationException {
        ...
        @Override
        public void encode(SerializationContext context, SetPublishingModeResponse encodable, OpcBinaryStreamWriter writer) throws UaSerializationException {
    ...
    public static class XmlCodec implements OpcXmlDataTypeCodec<SetPublishingModeResponse> {
        @Override
        public SetPublishingModeResponse decode(SerializationContext context, OpcXmlStreamReader reader) throws UaSerializationException {
            ResponseHeader _responseHeader = (ResponseHeader) context.decode(OpcUaDataTypeDictionary.NAMESPACE_URI, "ResponseHeader", reader);
        ...
        @Override
        public void encode(SerializationContext context, SetPublishingModeResponse encodable, OpcXmlStreamWriter writer) throws UaSerializationException {
            context.encode(OpcUaDataTypeDictionary.NAMESPACE_URI, "ResponseHeader", encodable._responseHeader, writer);
