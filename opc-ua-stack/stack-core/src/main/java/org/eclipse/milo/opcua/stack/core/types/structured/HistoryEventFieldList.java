...
public class HistoryEventFieldList implements UaStructure {
    ...
    static {
        OpcUaTypeDictionary.registerEncoder(HistoryEventFieldList::encode, HistoryEventFieldList.class, BinaryEncodingId, XmlEncodingId);
        OpcUaTypeDictionary.registerDecoder(HistoryEventFieldList::decode, HistoryEventFieldList.class, BinaryEncodingId, XmlEncodingId);
    }
