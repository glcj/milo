...
public class ModifySubscriptionResponse implements UaResponseMessage {
    ...
    public static class BinaryCodec implements OpcBinaryTypeCodec<ModifySubscriptionResponse> {
        @Override
    ...
    public static class XmlCodec implements OpcXmlTypeCodec<ModifySubscriptionResponse> {
        @Override
