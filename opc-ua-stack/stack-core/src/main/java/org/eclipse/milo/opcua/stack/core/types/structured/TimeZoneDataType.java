...
public class TimeZoneDataType implements UaStructure {
    ...
    public static class BinaryCodec implements OpcBinaryTypeCodec<TimeZoneDataType> {
        @Override
    ...
    public static class XmlCodec implements OpcXmlTypeCodec<TimeZoneDataType> {
        @Override
