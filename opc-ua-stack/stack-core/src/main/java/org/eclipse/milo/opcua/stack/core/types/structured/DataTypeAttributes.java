...
public class DataTypeAttributes extends NodeAttributes {
    ...
    public static class BinaryCodec implements OpcBinaryTypeCodec<DataTypeAttributes> {
        @Override
    ...
    public static class XmlCodec implements OpcXmlTypeCodec<DataTypeAttributes> {
        @Override
