...
public class UpdateStructureDataDetails extends HistoryUpdateDetails {
    ...
    static {
        OpcUaTypeDictionary.registerEncoder(UpdateStructureDataDetails::encode, UpdateStructureDataDetails.class, BinaryEncodingId, XmlEncodingId);
        OpcUaTypeDictionary.registerDecoder(UpdateStructureDataDetails::decode, UpdateStructureDataDetails.class, BinaryEncodingId, XmlEncodingId);
    }
