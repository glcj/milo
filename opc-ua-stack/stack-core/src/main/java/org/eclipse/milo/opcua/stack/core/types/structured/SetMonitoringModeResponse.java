...
public class SetMonitoringModeResponse implements UaResponseMessage {
    ...
    static {
        OpcUaTypeDictionary.registerEncoder(SetMonitoringModeResponse::encode, SetMonitoringModeResponse.class, BinaryEncodingId, XmlEncodingId);
        OpcUaTypeDictionary.registerDecoder(SetMonitoringModeResponse::decode, SetMonitoringModeResponse.class, BinaryEncodingId, XmlEncodingId);
    }
