...
public class SetMonitoringModeResponse implements UaResponseMessage {
    ...
    public static class BinaryCodec implements OpcBinaryTypeCodec<SetMonitoringModeResponse> {
        @Override
    ...
    public static class XmlCodec implements OpcXmlTypeCodec<SetMonitoringModeResponse> {
        @Override
