...
public class FindServersOnNetworkRequest implements UaRequestMessage {
    ...
    public static class BinaryCodec implements OpcBinaryTypeCodec<FindServersOnNetworkRequest> {
        @Override
    ...
    public static class XmlCodec implements OpcXmlTypeCodec<FindServersOnNetworkRequest> {
        @Override
