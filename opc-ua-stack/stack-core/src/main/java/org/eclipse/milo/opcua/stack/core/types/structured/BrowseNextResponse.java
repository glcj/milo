...
public class BrowseNextResponse implements UaResponseMessage {
    ...
    public static class BinaryCodec implements OpcBinaryTypeCodec<BrowseNextResponse> {
        @Override
            ...
            BrowseResult[] _results =
                reader.readArray(
                    () -> (BrowseResult) context.decode(
                        OpcUaTypeDictionary.NAMESPACE_URI, "BrowseResult", reader),
                    BrowseResult.class
                );
        ...
        public void encode(SerializationContext context, BrowseNextResponse encodable, OpcBinaryStreamWriter writer) throws UaSerializationException {
            ...
            writer.writeArray(
                encodable._results,
                e -> context.encode(OpcUaTypeDictionary.NAMESPACE_URI, "BrowseResult", e, writer)
            );
            writer.writeArray(encodable._diagnosticInfos, writer::writeDiagnosticInfo);
        }
    }

    public static class XmlCodec implements OpcXmlTypeCodec<BrowseNextResponse> {
        @Override
        ...
        public void encode(SerializationContext context, BrowseNextResponse encodable, OpcXmlStreamWriter writer) throws UaSerializationException {
            ...
            writer.writeArray(
                "Results",
                encodable._results,
                (f, e) -> context.encode(OpcUaTypeDictionary.NAMESPACE_URI, "BrowseResult", e, writer)
            );
