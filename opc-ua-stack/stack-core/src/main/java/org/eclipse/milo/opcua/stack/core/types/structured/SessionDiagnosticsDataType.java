...
public class SessionDiagnosticsDataType implements UaStructure {
    ...
    public static class BinaryCodec implements OpcBinaryDataTypeCodec<SessionDiagnosticsDataType> {
        ...
        public SessionDiagnosticsDataType decode(SerializationContext context, OpcBinaryStreamReader reader) throws UaSerializationException {
            ...
            ServiceCounterDataType _totalRequestCount = (ServiceCounterDataType) context.decode(OpcUaDataTypeDictionary.NAMESPACE_URI, "ServiceCounterDataType", reader);
            UInteger _unauthorizedRequestCount = reader.readUInt32();
            ServiceCounterDataType _readCount = (ServiceCounterDataType) context.decode(OpcUaDataTypeDictionary.NAMESPACE_URI, "ServiceCounterDataType", reader);
            ServiceCounterDataType _historyReadCount = (ServiceCounterDataType) context.decode(OpcUaDataTypeDictionary.NAMESPACE_URI, "ServiceCounterDataType", reader);
            ServiceCounterDataType _writeCount = (ServiceCounterDataType) context.decode(OpcUaDataTypeDictionary.NAMESPACE_URI, "ServiceCounterDataType", reader);
            ServiceCounterDataType _historyUpdateCount = (ServiceCounterDataType) context.decode(OpcUaDataTypeDictionary.NAMESPACE_URI, "ServiceCounterDataType", reader);
            ServiceCounterDataType _callCount = (ServiceCounterDataType) context.decode(OpcUaDataTypeDictionary.NAMESPACE_URI, "ServiceCounterDataType", reader);
            ServiceCounterDataType _createMonitoredItemsCount = (ServiceCounterDataType) context.decode(OpcUaDataTypeDictionary.NAMESPACE_URI, "ServiceCounterDataType", reader);
            ServiceCounterDataType _modifyMonitoredItemsCount = (ServiceCounterDataType) context.decode(OpcUaDataTypeDictionary.NAMESPACE_URI, "ServiceCounterDataType", reader);
            ServiceCounterDataType _setMonitoringModeCount = (ServiceCounterDataType) context.decode(OpcUaDataTypeDictionary.NAMESPACE_URI, "ServiceCounterDataType", reader);
            ServiceCounterDataType _setTriggeringCount = (ServiceCounterDataType) context.decode(OpcUaDataTypeDictionary.NAMESPACE_URI, "ServiceCounterDataType", reader);
            ServiceCounterDataType _deleteMonitoredItemsCount = (ServiceCounterDataType) context.decode(OpcUaDataTypeDictionary.NAMESPACE_URI, "ServiceCounterDataType", reader);
            ServiceCounterDataType _createSubscriptionCount = (ServiceCounterDataType) context.decode(OpcUaDataTypeDictionary.NAMESPACE_URI, "ServiceCounterDataType", reader);
            ServiceCounterDataType _modifySubscriptionCount = (ServiceCounterDataType) context.decode(OpcUaDataTypeDictionary.NAMESPACE_URI, "ServiceCounterDataType", reader);
            ServiceCounterDataType _setPublishingModeCount = (ServiceCounterDataType) context.decode(OpcUaDataTypeDictionary.NAMESPACE_URI, "ServiceCounterDataType", reader);
            ServiceCounterDataType _publishCount = (ServiceCounterDataType) context.decode(OpcUaDataTypeDictionary.NAMESPACE_URI, "ServiceCounterDataType", reader);
            ServiceCounterDataType _republishCount = (ServiceCounterDataType) context.decode(OpcUaDataTypeDictionary.NAMESPACE_URI, "ServiceCounterDataType", reader);
            ServiceCounterDataType _transferSubscriptionsCount = (ServiceCounterDataType) context.decode(OpcUaDataTypeDictionary.NAMESPACE_URI, "ServiceCounterDataType", reader);
            ServiceCounterDataType _deleteSubscriptionsCount = (ServiceCounterDataType) context.decode(OpcUaDataTypeDictionary.NAMESPACE_URI, "ServiceCounterDataType", reader);
            ServiceCounterDataType _addNodesCount = (ServiceCounterDataType) context.decode(OpcUaDataTypeDictionary.NAMESPACE_URI, "ServiceCounterDataType", reader);
            ServiceCounterDataType _addReferencesCount = (ServiceCounterDataType) context.decode(OpcUaDataTypeDictionary.NAMESPACE_URI, "ServiceCounterDataType", reader);
            ServiceCounterDataType _deleteNodesCount = (ServiceCounterDataType) context.decode(OpcUaDataTypeDictionary.NAMESPACE_URI, "ServiceCounterDataType", reader);
            ServiceCounterDataType _deleteReferencesCount = (ServiceCounterDataType) context.decode(OpcUaDataTypeDictionary.NAMESPACE_URI, "ServiceCounterDataType", reader);
            ServiceCounterDataType _browseCount = (ServiceCounterDataType) context.decode(OpcUaDataTypeDictionary.NAMESPACE_URI, "ServiceCounterDataType", reader);
            ServiceCounterDataType _browseNextCount = (ServiceCounterDataType) context.decode(OpcUaDataTypeDictionary.NAMESPACE_URI, "ServiceCounterDataType", reader);
            ServiceCounterDataType _translateBrowsePathsToNodeIdsCount = (ServiceCounterDataType) context.decode(OpcUaDataTypeDictionary.NAMESPACE_URI, "ServiceCounterDataType", reader);
            ServiceCounterDataType _queryFirstCount = (ServiceCounterDataType) context.decode(OpcUaDataTypeDictionary.NAMESPACE_URI, "ServiceCounterDataType", reader);
            ServiceCounterDataType _queryNextCount = (ServiceCounterDataType) context.decode(OpcUaDataTypeDictionary.NAMESPACE_URI, "ServiceCounterDataType", reader);
            ServiceCounterDataType _registerNodesCount = (ServiceCounterDataType) context.decode(OpcUaDataTypeDictionary.NAMESPACE_URI, "ServiceCounterDataType", reader);
            ServiceCounterDataType _unregisterNodesCount = (ServiceCounterDataType) context.decode(OpcUaDataTypeDictionary.NAMESPACE_URI, "ServiceCounterDataType", reader);
        ...
        public void encode(SerializationContext context, SessionDiagnosticsDataType encodable, OpcBinaryStreamWriter writer) throws UaSerializationException {
            ...
            context.encode(OpcUaDataTypeDictionary.NAMESPACE_URI, "ServiceCounterDataType", encodable._totalRequestCount, writer);
            writer.writeUInt32(encodable._unauthorizedRequestCount);
            context.encode(OpcUaDataTypeDictionary.NAMESPACE_URI, "ServiceCounterDataType", encodable._readCount, writer);
            context.encode(OpcUaDataTypeDictionary.NAMESPACE_URI, "ServiceCounterDataType", encodable._historyReadCount, writer);
            context.encode(OpcUaDataTypeDictionary.NAMESPACE_URI, "ServiceCounterDataType", encodable._writeCount, writer);
            context.encode(OpcUaDataTypeDictionary.NAMESPACE_URI, "ServiceCounterDataType", encodable._historyUpdateCount, writer);
            context.encode(OpcUaDataTypeDictionary.NAMESPACE_URI, "ServiceCounterDataType", encodable._callCount, writer);
            context.encode(OpcUaDataTypeDictionary.NAMESPACE_URI, "ServiceCounterDataType", encodable._createMonitoredItemsCount, writer);
            context.encode(OpcUaDataTypeDictionary.NAMESPACE_URI, "ServiceCounterDataType", encodable._modifyMonitoredItemsCount, writer);
            context.encode(OpcUaDataTypeDictionary.NAMESPACE_URI, "ServiceCounterDataType", encodable._setMonitoringModeCount, writer);
            context.encode(OpcUaDataTypeDictionary.NAMESPACE_URI, "ServiceCounterDataType", encodable._setTriggeringCount, writer);
            context.encode(OpcUaDataTypeDictionary.NAMESPACE_URI, "ServiceCounterDataType", encodable._deleteMonitoredItemsCount, writer);
            context.encode(OpcUaDataTypeDictionary.NAMESPACE_URI, "ServiceCounterDataType", encodable._createSubscriptionCount, writer);
            context.encode(OpcUaDataTypeDictionary.NAMESPACE_URI, "ServiceCounterDataType", encodable._modifySubscriptionCount, writer);
            context.encode(OpcUaDataTypeDictionary.NAMESPACE_URI, "ServiceCounterDataType", encodable._setPublishingModeCount, writer);
            context.encode(OpcUaDataTypeDictionary.NAMESPACE_URI, "ServiceCounterDataType", encodable._publishCount, writer);
            context.encode(OpcUaDataTypeDictionary.NAMESPACE_URI, "ServiceCounterDataType", encodable._republishCount, writer);
            context.encode(OpcUaDataTypeDictionary.NAMESPACE_URI, "ServiceCounterDataType", encodable._transferSubscriptionsCount, writer);
            context.encode(OpcUaDataTypeDictionary.NAMESPACE_URI, "ServiceCounterDataType", encodable._deleteSubscriptionsCount, writer);
            context.encode(OpcUaDataTypeDictionary.NAMESPACE_URI, "ServiceCounterDataType", encodable._addNodesCount, writer);
            context.encode(OpcUaDataTypeDictionary.NAMESPACE_URI, "ServiceCounterDataType", encodable._addReferencesCount, writer);
            context.encode(OpcUaDataTypeDictionary.NAMESPACE_URI, "ServiceCounterDataType", encodable._deleteNodesCount, writer);
            context.encode(OpcUaDataTypeDictionary.NAMESPACE_URI, "ServiceCounterDataType", encodable._deleteReferencesCount, writer);
            context.encode(OpcUaDataTypeDictionary.NAMESPACE_URI, "ServiceCounterDataType", encodable._browseCount, writer);
            context.encode(OpcUaDataTypeDictionary.NAMESPACE_URI, "ServiceCounterDataType", encodable._browseNextCount, writer);
            context.encode(OpcUaDataTypeDictionary.NAMESPACE_URI, "ServiceCounterDataType", encodable._translateBrowsePathsToNodeIdsCount, writer);
            context.encode(OpcUaDataTypeDictionary.NAMESPACE_URI, "ServiceCounterDataType", encodable._queryFirstCount, writer);
            context.encode(OpcUaDataTypeDictionary.NAMESPACE_URI, "ServiceCounterDataType", encodable._queryNextCount, writer);
            context.encode(OpcUaDataTypeDictionary.NAMESPACE_URI, "ServiceCounterDataType", encodable._registerNodesCount, writer);
            context.encode(OpcUaDataTypeDictionary.NAMESPACE_URI, "ServiceCounterDataType", encodable._unregisterNodesCount, writer);
        }
    }
