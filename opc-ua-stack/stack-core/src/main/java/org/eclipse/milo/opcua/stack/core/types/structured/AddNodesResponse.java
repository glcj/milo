...
public class AddNodesResponse implements UaResponseMessage {
    ...
    public static class BinaryCodec implements OpcBinaryTypeCodec<AddNodesResponse> {
        @Override
            ...
            AddNodesResult[] _results =
                reader.readArray(
                    () -> (AddNodesResult) context.decode(
                        OpcUaTypeDictionary.NAMESPACE_URI, "AddNodesResult", reader),
        ...
        public void encode(SerializationContext context, AddNodesResponse encodable, OpcBinaryStreamWriter writer) throws UaSerializationException {
            ...
            writer.writeArray(
                encodable._results,
                e -> context.encode(OpcUaTypeDictionary.NAMESPACE_URI, "AddNodesResult", e, writer)
            );
            writer.writeArray(encodable._diagnosticInfos, writer::writeDiagnosticInfo);
        }
    }

    public static class XmlCodec implements OpcXmlTypeCodec<AddNodesResponse> {
        @Override
        ...
        public void encode(SerializationContext context, AddNodesResponse encodable, OpcXmlStreamWriter writer) throws UaSerializationException {
            ...
            writer.writeArray(
                "Results",
                encodable._results,
                (f, e) -> context.encode(OpcUaTypeDictionary.NAMESPACE_URI, "AddNodesResult", e, writer)
            );
