...
public class EndpointConfiguration implements UaStructure {
    ...
    public static class BinaryCodec implements OpcBinaryTypeCodec<EndpointConfiguration> {
        @Override
    ...
    public static class XmlCodec implements OpcXmlTypeCodec<EndpointConfiguration> {
        @Override
