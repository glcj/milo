...
public class ObjectTypeNode extends TypeNode {
    ...
    static {
        OpcUaTypeDictionary.registerEncoder(ObjectTypeNode::encode, ObjectTypeNode.class, BinaryEncodingId, XmlEncodingId);
        OpcUaTypeDictionary.registerDecoder(ObjectTypeNode::decode, ObjectTypeNode.class, BinaryEncodingId, XmlEncodingId);
    }
