...
public class MonitoringFilter implements UaStructure {
    ...
    public static class BinaryCodec implements OpcBinaryTypeCodec<MonitoringFilter> {
        @Override
    ...
    public static class XmlCodec implements OpcXmlTypeCodec<MonitoringFilter> {
        @Override
