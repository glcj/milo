...
public class MonitoringFilter implements UaStructure {
    ...
    static {
        OpcUaTypeDictionary.registerEncoder(MonitoringFilter::encode, MonitoringFilter.class, BinaryEncodingId, XmlEncodingId);
        OpcUaTypeDictionary.registerDecoder(MonitoringFilter::decode, MonitoringFilter.class, BinaryEncodingId, XmlEncodingId);
    }
